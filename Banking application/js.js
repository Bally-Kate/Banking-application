...
const account1 = {
  ...
  movementsDates: [
    ...
    "2025-01-22T17:01:17.194Z",
    "2025-01-27T23:36:17.929Z",
...
// Отображение операций зачисления и снятие на счёте
...
btnLogin.addEventListener("click", function (e) {
  ...
  if (currentAccount && currentAccount.pin === Number(inputLoginPin.value)) {
    ...
    labelDate.textContent = Intl.DateTimeFormat(local, option).format()
...
console.log(Math.round(res / 1000 / 60 / 60 / 24)) */


//Форматы разных стран
/* const local = navigator.language
console.log(local)
...
const now = new Date()
const gb = Intl.DateTimeFormat(local, option).format(now)
console.log(gb) */


//Форматы чисел разных стран
/* const num = 123719748913764987134
const local = navigator.language
const option = {
  style: 'currency',
  currency: 'USD'
...
const ru = Intl.NumberFormat(local, option).format(num)
console.log(ru)

const ger = Intl.NumberFormat('de-DE', option).format(num)
console.log(ger)

const ar = Intl.NumberFormat('ar-SY', option).format(num)
console.log(ar) */
...
const timer2 = setInterval(() => console.log('Hi'), 10000)
